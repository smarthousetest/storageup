...
import '../pages/loadind_files.dart/loading_container_bloc.dart' as _i17;
...
import 'controllers/load/load_controller.dart' as _i29;
import 'controllers/load/load_state_local_storage.dart' as _i16;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingletonAsync<_i16.LoadStateStorage>(
      () => _i16.LoadStateStorage.create());
  gh.factory<_i17.LoadingContainerBloc>(() => _i17.LoadingContainerBloc());
  gh.factory<_i18.MediaOpenBloc>(() => _i18.MediaOpenBloc(
      get<_i7.FilesController>(instanceName: 'files_controller')));
  ...
  gh.factory<_i26.AuthService>(
      () => _i26.AuthService(get<_i5.Dio>(instanceName: 'auth_dio')));
  ...
  gh.factory<_i28.FilesBloc>(() => _i28.FilesBloc(
      get<_i7.FilesController>(instanceName: 'files_controller')));
  gh.lazySingleton<_i29.LoadController>(
      () => _i29.LoadController(get<_i23.TokenRepository>()));
  return get;
}
