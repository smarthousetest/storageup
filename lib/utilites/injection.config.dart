...
import '../pages/media/media_open/media_open_bloc.dart' as _i15;
import '../pages/settings/settings_bloc.dart' as _i18;
...
import 'controllers/user_controller.dart' as _i21;
import 'repositories/auth_repository.dart' as _i24;
import 'repositories/file_repository.dart' as _i8;
import 'repositories/media_repository.dart' as _i16;
import 'repositories/space_repository.dart' as _i6;
import 'repositories/token_repository.dart' as _i20;
import 'repositories/user_repository.dart' as _i22;
import 'services/auth_service.dart' as _i23;
import 'services/files_service.dart' as _i9;
import 'services/services_module.dart' as _i26;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i15.MediaOpenBloc>(() => _i15.MediaOpenBloc(
      get<_i7.FilesController>(instanceName: 'files_controller')));
  gh.factory<_i16.MediaRepository>(() => _i16.MediaRepository());
  gh.lazySingleton<_i16.MediaRepository>(() => serviceModule.mediaRepo,
      instanceName: 'media_repo');
  gh.singleton<_i17.S>(serviceModule.s);
  gh.factory<_i18.SettingsBloc>(() => _i18.SettingsBloc());
  gh.factory<_i19.SubscriptionService>(() => _i19.SubscriptionService());
  gh.factory<_i20.TokenRepository>(() => _i20.TokenRepository());
  gh.factory<_i21.UserController>(() => _i21.UserController());
  gh.lazySingleton<_i22.UserRepository>(() => serviceModule.userRepository,
      instanceName: 'user_repo');
  gh.factory<_i23.AuthService>(
      () => _i23.AuthService(get<_i5.Dio>(instanceName: 'auth_dio')));
  gh.singleton<_i24.AuthenticationRepository>(
      _i24.AuthenticationRepository(get<_i23.AuthService>()));
  gh.factory<_i25.FilesBloc>(() => _i25.FilesBloc(
      get<_i7.FilesController>(instanceName: 'files_controller')));
  return get;
}
