...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i23.UserRepository>(() => serviceModule.userRepository,
      instanceName: 'user_repo');
  gh.factory<_i24.AuthService>(
      () => _i24.AuthService(get<_i4.Dio>(instanceName: 'auth_dio')));
  gh.singleton<_i25.AuthenticationRepository>(
      _i25.AuthenticationRepository(get<_i24.AuthService>()));
  gh.factory<_i26.FilesBloc>(() => _i26.FilesBloc(
      get<_i6.FilesController>(instanceName: 'files_controller')));
  return get;
}
